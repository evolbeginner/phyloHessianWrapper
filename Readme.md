...
*   `--no_mwopt`: Disable optimization of mixture weights (not recommended).
    *   Options: if specified  `--mwopt` for `IQ-Tree` will be turned off.
...
- See also the very nicely written tutorial [dos Reis, et al. 2017](#ref-dosreis_2017)
...
-  <a id="ref-Wang_Meade_2026"></a>Wang S, Meade A. Molecular Clock Dating Using Complex Mixture Models: Applied to Ancient Symbionts. Mol. Biol. Evol. msag039.
